# Contributing to react-reducks

Thank you for considering to help `react-reducks`.
...
The Github [issue tracker](https://github.com/phixo/react-reducks/issues) is the preferred channel for bug reports,
